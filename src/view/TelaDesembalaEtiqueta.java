 ...
 */
public class TelaDesembalaEtiqueta extends javax.swing.JDialog {
     ...
     */
    public TelaDesembalaEtiqueta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
        populaComboEmitente();
    ...
    private void initComponents() {
        ...
        setTitle("Gestão77 - Desembala Etiqueta");
        setResizable(false);
        ...
        buttonCarregar.setText("Reabrir");
    ...
    public boolean valida() {
        ...
        if (etiquetaIndividual.getSituacao() != 3) {
            JOptionPane.showMessageDialog(this, "Etiqueta não está embalada", "Etiqueta não está embalada", JOptionPane.ERROR_MESSAGE);
            return false;
        }
    ...
    private void reabreCaixa() {

        int resposta = JOptionPane.showConfirmDialog(null, "Confirma reabertura da etiqueta? " + etiquetaIndividual.getChaveUnica() + "?", "Confirmação", JOptionPane.YES_NO_OPTION);
        if (resposta == 0) {
            
            EtiquetaDAO etiquetaDAO = new EtiquetaDAO();
            
            etiquetaIndividual.setSituacao(2);
            
            etiquetaDAO.update(etiquetaIndividual);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDesembalaEtiqueta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaDesembalaEtiqueta dialog = new TelaDesembalaEtiqueta(new javax.swing.JFrame(), true);
