...
public class TelaLogin extends javax.swing.JDialog {
    ...
    private void validar(){
        ...
        Usuario usuario = usuarioDAO.selectWhereLogin(textUsuario.getText());
        if(usuario == null){
            JOptionPane.showMessageDialog(null, "Usuário inexistente", "Erro", JOptionPane.ERROR_MESSAGE);
        }else{
            if(!usuario.getSenha().equals(textSenha.getText())){
                JOptionPane.showMessageDialog(null, "Senha incorreta", "Erro", JOptionPane.ERROR_MESSAGE);
            }else{
                VariavelGlobal.getInstancec().setUsuarioLogado(textUsuario.getText());
                doClose(RET_OK);
            }
        }
